...
- **Time scrubber** — Drag a 3-hour window along a rolling 24-hour axis to see what's happening later tonight or tomorrow morning. Runs on the UI thread (Reanimated) for 60 fps scrubbing.
